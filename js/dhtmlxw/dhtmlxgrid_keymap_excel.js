...
dhtmlXGridObject.prototype._key_events={
			...
			k9_0_0:function(){
				this.editStop();
				this.callEvent("onTab",[(this.row?this.row.idd:null),(this.cell?this.cell._cellIndex:null)]);
				this._still_active=true;
				this._key_events.k40_0_0.call(this);
            },
            k13_0_0:function(){
				this.editStop();
				if (!this.callEvent("onEnter",[true])) return true;
			...
			k13_0_1:function(){
				this.editStop();
				if (!this.callEvent("onEnter",[false])) return true;
			...
			k37_0_0:function(){
            	...
            	else this._key_events.k13_0_1.call(this);
	        },
			k39_0_0:function(){
				if (this.editor) return false;
				if(!this.editor && this.isTreeGrid())
            		this.expandKids(this.row)
            	else this._key_events.k13_0_0.call(this);
            },
			k37_1_0:function(){
				if (this.editor) return false;
