...
dhtmlXGridObject.prototype._key_events={k9_1_0:function(){this.editStop()},k9_0_1:function(){this._key_events.k13_0_1.call(this)},k9_0_0:function(){this._key_events.k13_0_0.call(this)},k13_0_0:function(){this.editStop();if(!this.callEvent("onTab",[!0]))return!0;var a=this._getNextCell(null,1);if(a)this.pagingOn&&this.showRow(a.parentNode.idd),this.selectCell(a.parentNode,a._cellIndex,this.row!=a.parentNode,!1,!0),this._still_active=!0;this._select_ifpossible()},k13_0_1:function(){this.editStop();if(!this.callEvent("onTab",
...
1):this.scrollPage(1)},k37_0_0:function(){if(this.editor)return!1;this.isTreeGrid()?this.collapseKids(this.row):this._key_events.k13_0_1.call(this)},k39_0_0:function(){if(this.editor)return!1;!this.editor&&this.isTreeGrid()?this.expandKids(this.row):this._key_events.k13_0_0.call(this)},k37_1_0:function(){if(this.editor)return!1;this.selectCell(this.row,0,!1,!1,!0);this._select_ifpossible()},k39_1_0:function(){if(this.editor)return!1;this.selectCell(this.row,this._cCount-1,!1,!1,!0);this._select_ifpossible()},
