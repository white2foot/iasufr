...
function dhtmlXMenuObject(baseId, skin) {
	...
	*/
	...
	this._doOnClick = function(id, type, casState, button) {
		...
		if (this.checkEvent("onClick")) {
			...
			this.callEvent("onClick", [id, this.contextMenuZoneId, casState, button]);
		} else {
...
dhtmlXMenuObject.prototype._renderToplevelItem = function(id, pos) {
	...
	*/
	...
	m.onclick = function(e) {
		...
		main_self._doOnClick(this.id.replace(main_self.idPrefix, ""), tc+td+"t", cas, e.button);
		return false;
	}
	...
	tr.onclick = function(e) {
		...
		switch (main_self.itemPull[this.id]["type"]) {
			...
			case "radio":
				...
				break;
			case "item":
				main_self._doOnClick(this.id.replace(main_self.idPrefix, ""), tc+td+"n", cas, e.button);
				break;
		}
		return false;
	}
